...
DEFINE_FUNCTION fnLoadVideoInputLabels()
{
    ...
    {
	SEND_COMMAND dvTP_Main, "'^TXT-',ITOA(nInputBtns[cLoop]),',0,',ITOA(cLoop),$0A,$0D,nSwitchInputNames[cLoop]"
	SEND_COMMAND dvTP_Main, "'^TXT-',ITOA(nOutputBtns[cLoop]),',0,',ITOA(cLoop),$0A,$0D,nSwitchOutputNames[cLoop]"
