MODULE_NAME='Sony_VPL_FHZ131L_PJTALK_Comm' (DEV vdvDevice, DEV dvDevice, CHAR devIP[])
...
CHAR PROJECTOR_IP_LAMP_QUERY[] =	{$02,$0A,$53,$4F,$4E,$59,$00,$70,$00,$08,$A9,$01,$13,$01,$00,$00,$13,$9A}
CHAR PROJ_HEADER[]				= {$02,$0A,$53,$4F,$4E,$59,$01,$70,$00,$08} // Older Sony's
...
DEFINE_FUNCTION fnParsePJTalkResponse(CHAR iMsg[])
{
	...
	SELECT
	{
	    ACTIVE (FIND_STRING(cProjectorStat, "$A9,$01,$02,$02,$00,$03,$03,$9A",1)) : {

		bPwr = TRUE;
		    [vdvDevice, 255] = bPwr;
			SEND_COMMAND vdvDevice, "'PJTALK-PWRON'"
	    }
	    ACTIVE (FIND_STRING(cProjectorStat, "$A9,$01,$02,$02,$00,$00,$03,$9A",1)) : {
		bPwr = FALSE;
		    [vdvDevice, 255] = bPwr;
			SEND_COMMAND vdvDevice, "'PJTALK-PWROFF'"
	    }
	    ACTIVE (FIND_STRING(cProjectorStat, "$A9,$00,$30,$02,$00,$00,$32,$9A",1)) : {
		bMute = FALSE;
		    [vdvDevice, 211] = bMute;
			SEND_COMMAND vdvDevice, "'PJTALK-MUTEOFF'"
	    }
	    ACTIVE (FIND_STRING(cProjectorStat, "$A9,$00,$30,$02,$00,$01,$33,$9A",1)) : {
		bMute = TRUE;
		    [vdvDevice, 211] = bMute;
			SEND_COMMAND vdvDevice, "'PJTALK-MUTEON'"
	    }
	     ACTIVE (FIND_STRING(cProjectorStat, "$A9,$01,$13,$02",1)) : {
